        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < infos.length(); i++) {
                    ...
                    list.append(info.getString("combustibles")+ "," + info.getString("incombustibles") + "," + info.getString("pet") + "," + info.getString("can") + "," + info.getString("place") + "," + info.getString("open_bit") + "," + info.getString("reason") + "," + info.getString("name"));
                }
